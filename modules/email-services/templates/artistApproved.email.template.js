...
export const prepareArtistApprovedEmailTemplate = ({ userName, artistName }) => {
  const subject = `You're officially an Artist 🎉`;

  const text = `
Hi ${userName},

Great news — your artist profile "${artistName}" has been approved.
...
Open your dashboard:
https://www.musicreset.com/artist/dashboard
...
`;
  ...
  const html = `
    ...
    <p>
    Your artist profile <b>${artistName}</b> has been approved.
    </p>

    <p>You can now start your journey on Reset Music.</p>
