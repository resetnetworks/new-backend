...
export const handleEmailJob = async (job) => {
  ...
  console.log("=================== job ===================");
  console.log("Dispatching:", jobName);

  switch (jobName) {
    case EMAIL_JOBS.USER_WELCOME:
      console.log(`\n👉 👉 👉 👉 You are in jobDispatcher : ${globalEmailCounter} 👈 👈 👈 👈`)
      console.log("Processing the sendRegisrationEmail");
      console.log("INSIDE THE USER WELCOME JOB DISPATCHER: ", payload)
      return processAndSendRegistrationEmail(payload);

    case EMAIL_JOBS.PASSWORD_RESET:
      console.log(`\n👉 👉 👉 👉 You are in jobDispatcher : ${globalEmailCounter} 👈 👈 👈 👈`)
      console.log("Processing the ProcessAndSendPasswordResetEmail");
      console.log("INSIDE THE PASSWORD RESET JOB DISPATCHER: ", payload)
      return processAndSendPasswordResetEmail(payload);

    case EMAIL_JOBS.ARTIST_APPROVED:
      console.log(`\n👉 👉 👉 👉 You are in jobDispatcher : ${globalEmailCounter} 👈 👈 👈 👈`)
      console.log("Processing ARTIST_APPROVAL email")
      console.log("INSIDE THE ARTIST APPROVED JOB DISPATCHER: ", payload)
      return processAndSendArtistApprovedEmail(payload);

    case EMAIL_JOBS.INVOICE_ONE_TIME_PAYMENT:
      console.log(`\n👉 👉 👉 👉 You are in jobDispatcher : ${globalEmailCounter} 👈 👈 👈 👈`)
      console.log("Processing ONE_TIME_INVOICE email")
      console.log("INSIDE THE INVOICE ONE TIME JOB DISPATCHER: ", payload)
      return processAndSendOneTimeInvoiceEmail(payload);

    case EMAIL_JOBS.INVOICE_SUBSCRIPTION_STARTED:
      console.log(`\n👉 👉 👉 👉 You are in jobDispatcher : ${globalEmailCounter} 👈 👈 👈 👈`)
      console.log("Processing SUBSCRIPTION_INVOICE email")
      console.log("INSIDE THE SUBSCRIPTION JOB DISPATCHER: ", payload)
      return processAndSendSubscriptionInvoiceEmail(payload);

    case EMAIL_JOBS.SUBSCRIPTION_CANCELLED:
      console.log(`\n👉 👉 👉 👉 You are in jobDispatcher : ${globalEmailCounter} 👈 👈 👈 👈`)
      console.log("\nProcessing CANCELLATION invoice email");
      console.log("INSIDE THE SUBSCRIPTION CANCELLATION JOB DISPATCHER: ", payload)
      return processAndSendSubscriptionCancelledEmail(payload);
